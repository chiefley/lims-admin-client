...
public class LabAssetSopFieldRs : SingleValueSopFieldRs
{
    ...
    // Dropdown control.  Use SopMaintenanceSelectors.LatAssetTypes.
    [Required]
...
public class InstrumentTypeSopFieldRs : SingleValueSopFieldRs
{
    ...
    // Dropdown control.  Use SopMaintenanceSelectors.InstrumentTypes.
    [Required]
...
public class SopEnumSopFieldRs : SingleValueSopFieldRs
{
    ...
    // Dropdown control.  Use SopMaintenanceSelectors.SopEnumTypes.
    [Required]
...
public class UserSopFieldRs : SingleValueSopFieldRs
{
    ...
    // Dropdown control.  Use SopMaintenanceSelectors.UserRoles
    [Required]
