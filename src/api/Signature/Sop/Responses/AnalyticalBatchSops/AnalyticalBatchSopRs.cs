...
public class AnalyticalBatchSopRs : BatchSopRs
{
    ...
    // Dropdown control.   Choices come from SopMaintenanceSelectors.ReportPercentTypes
    [Required]
    ...
    // Dropdown control.   Choices come from SopMaintenanceSelectors.AnalysisMethodTypes
    [Required]
    public ManifestSampleAnalysisMethodType AnalysisMethodType { get; set; }
    // Dropdown control.   Choices come from SopMaintenanceSelectors.AggregateRollupMethodTypes
    [Required]
    public AggregateRollupMethodType AggregateRollupMethodType { get; set; }
    // Dropdown control.   Choices come from SopMaintenanceSelectors.ComparisonTypes
    [Required]
