...
public interface ISopMaintenanceService
{
    Task<SopMaintenanceSelectors> FetchSelectors(int labId);
...
public class SopMaintenanceService : ISopMaintenanceService
{
    ...
    public async Task<SopMaintenanceSelectors> FetchSelectors(int labId)
    {
        ...
        var ret = new SopMaintenanceSelectors
        {
